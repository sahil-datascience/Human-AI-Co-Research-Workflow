...
def evaluation_theoretical_orientation_node(state: DSRPState):
    ...
    evidence_llm = llm.with_structured_output(TheoryEvidenceSchema)
    ...
    classifier_llm = llm.with_structured_output(TheoryOrientationSchema)
    ...
    auditor_llm = llm.with_structured_output(TheoryOrientationSchema)
